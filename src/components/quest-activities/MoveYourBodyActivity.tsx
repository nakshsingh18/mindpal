...
interface MoveYourBodyActivityProps {
  onComplete: () => void;
  onBack: () => void;
  petType?: string;
}

export function MoveYourBodyActivity({ onComplete, onBack, petType = 'dog' }: MoveYourBodyActivityProps) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-100 via-teal-50 to-blue-100 p-6">
      <div className="max-w-md mx-auto">
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-xl font-medium">Move Your Body</h1>
          <div className="w-16" />
        </div>
        ...
        <Card className="p-8 text-center bg-white/80 backdrop-blur-sm border-0 shadow-lg rounded-3xl">
          <div className="mb-6 w-32 h-32 mx-auto">
            <div dangerouslySetInnerHTML={{ __html: getGifEmbed(petType, 'exercise') }} />
          </div>

          <div className="text-6xl font-mono mb-4 text-green-600">
            {formatTime(timeLeft)}
          </div>

          <p className="text-gray-600 mb-6">
            Get your body moving! Dance, stretch, walk, or do any physical activity
          </p>
          ...
          {!isCompleted ? (
            ...
            >
              ...
              <p className="text-green-600 font-medium">Awesome! You moved your body for 10 minutes.</p>
              <Button
